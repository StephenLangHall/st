 ...
 */
static char *font = "Fira Code:style=Regular:pixelsize=20:antialias=true:autohint=true";
//static char *font = "Ubuntu Mono:style=Regular:pixelsize=20:antialias=true:autohint=true";
//static char *font = "bitocra:pixelsize=12:antialias=true:autohint=true";
...
/*
 * Default colour of the mouse cursor
 */
